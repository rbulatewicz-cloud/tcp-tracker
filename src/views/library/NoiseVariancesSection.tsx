...
import { NoiseVariance, VarianceExpiryStatus, User, UserRole, AppConfig } from '../../types';
...
function VarianceCard({
  active, history, canManage, onDelete, onRetry, onUploadRevision, appConfig,
}: {
...
export const NoiseVariancesSection: React.FC<NoiseVariancesSectionProps> = ({ currentUser, appConfig }) => {
