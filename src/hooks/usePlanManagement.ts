...
export const usePlanManagement = (plans: Plan[]) => {
  ...
  const [filter, setFilter] = useState<FilterState>({ stage: "all", type: "all", lead: "all", priority: "all", importStatus: "all", requestedBy: "all", scope: "all", impacts: [], quickFilter: "all" });
